...
{if $homepage->getMarketConnectCount() != 0 && !empty($homepage->getPromotionBanner())}
    <div data-promo-slider>
        <div class="site-banner site-slider banner banner-head banner-sides banner-elipse banner-{$siteBannerStyle}{if $homepage->getMarketConnectCount() == 1 || !$RSThemes['pages'][$templatefile]['config']['showSliderNavigation']} slider-single{/if}">
            <div class="container">
